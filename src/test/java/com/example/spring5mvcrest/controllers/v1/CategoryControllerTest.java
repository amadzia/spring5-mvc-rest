...
import com.example.spring5mvcrest.controllers.RestResponseEntityExceptionHandler;
...
public class CategoryControllerTest {
    ...
    public void getCategoryByNameTest() throws Exception {
        ...
        mockMvc.perform(get(CategoryController.BASE_URL + "/Ann")
                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
    ...
    public void notFoundExceptionTest() throws Exception {
        ...
        mockMvc.perform(get(CategoryController.BASE_URL + "/someString")
                .contentType(MediaType.APPLICATION_JSON))
