...
public class VendorControllerITTest {
    ...
    public void setUp() throws Exception {
        ...
        vendorDTO_1 = new VendorDTO("First Vendor", VendorController.BASE_URL + "/1");
        vendorDTO_2 = new VendorDTO("Second Vendor", VendorController.BASE_URL + "/2");
    }

    @Test
    public void getListOfVendorsTest() throws Exception {
